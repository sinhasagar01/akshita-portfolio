...
export default function SkipLink() {
  return (
    <a
      ...
      className="sr-only rounded-md border border-ink-950/8 bg-cream-50 px-4 py-2 text-[14px] font-medium text-ink-950 outline-2 outline-accent-500 focus-visible:not-sr-only focus-visible:fixed focus-visible:left-4 focus-visible:top-4 focus-visible:z-[100] focus-visible:outline"
    >
      Skip to content
    </a>
  );
