    ...
    <div className="relative flex-1">
      ...
      {showDropdown && (
        <ul
          ...
          className="absolute inset-x-0 top-full z-40 mt-1.5 max-h-72 overflow-auto rounded-md border border-ink-950/8 bg-cream-50 py-1 shadow-[0_8px_30px_rgba(60,45,30,0.14)]"
        >
          {results.length === 0 ? (
